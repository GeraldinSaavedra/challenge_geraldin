function encriptar(frase){
    ...
    var area_inic = document.querySelector("#default");
    var area_result = document.querySelector("#result");
    var texto_final = document.querySelector("#texto_out");
    if (texto != ""){
        var out = ""
        for(var i=0; i < texto.length; i++){
            if(((texto[i] < 'a') || (texto[i] > 'z')) && (texto[i] != ' ')){
                ...
                area_inic.classList.remove("invisible");
        ...
        area_inic.classList.add("invisible");
        area_result.classList.remove("invisible");
        texto_final.innerHTML = out;
    }
...
function copiar(){
    const texto_final = document.querySelector("#texto_out");
    navigator.clipboard.writeText(texto_final.value);
}
